...
class TestCleanFunction:
    ...
    def test_clean_arrays(self):
        ...
        assert np.allclose(cleaned, expected), "Complex array should be cleaned properly"
...
class TestPrintFunction:
    ...
    def test_print_complex_numbers(self):
        ...
        assert "1" in output and "2" in output, "Should contain real and imaginary parts"
...
class TestFormattedOutput:
    ...
    def test_formatted_matrix_output(self):
        ...
        assert "1.2" in formatted or "1.23" in formatted, "Should contain formatted elements"
...
class TestErrorHandling:
    ...
    def test_warning_handling(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert np.isfinite(result) or len(w) > 0, "Should handle or warn about numerical issues"
...
class TestUtilityIntegration:
    ...
    def test_comprehensive_workflow(self):
        ...
        matrix = np.array([[1.0 + 1e-15j, 2.0 - 1e-16j], 
                          [3.0 + 1e-14j, 4.0 - 1e-15j]])
        ...
        assert np.allclose(cleaned_matrix.real, [[1, 2], [3, 4]]), "Real parts should be preserved"
...
class TestPerformanceUtilities:
    ...
    def test_optimization_utilities(self):
        ...
        try:
            ...
            assert optimized.shape == matrix.shape, "Optimized matrix should have same shape"
        except AttributeError:
