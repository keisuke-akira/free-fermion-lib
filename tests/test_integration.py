...
class TestCrossModuleIntegration:
    ...
    def test_lib_combinatorics_integration(self):
        ...
        assert np.allclose(det_numpy, det_combinatorial), "Determinant methods should agree"
    ...
    def test_lib_utils_integration(self):
        ...
        # Verify integration
        assert np.allclose(H_clean.imag, 0), "Cleaning should remove small imaginary parts"
        assert gamma.shape == (n, n), "Correlation matrix should have correct shape"
        assert isinstance(formatted_gamma, str), "Should produce formatted string output"
...
class TestRealWorldUseCases:
    ...
    def test_quantum_error_correction_workflow(self):
        ...
        stabilizers = np.array([[1, 1, 0, 0],  # X1 X2
                               [0, 0, 1, 1]])  # X3 X4
...
class TestPerformanceIntegration:
    ...
    def test_large_system_performance(self):
        ...
        # Verify performance
        assert elapsed < 10.0, "Large system workflow should complete in reasonable time"
