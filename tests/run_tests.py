...
def generate_test_report():
    ...
    args = ["--html=test_report.html", "--self-contained-html", "-v"]
...
Examples:
    ...
    parser.add_argument(
        "--verbose", "-v", action="store_true", help="Increase verbosity level"
    )
    ...
    parser.add_argument(
        "--quick", action="store_true", help="Run only quick tests (skip slow tests)"
    )

    parser.add_argument("--parallel", action="store_true", help="Run tests in parallel")

    parser.add_argument(
        "--report", action="store_true", help="Generate detailed HTML test report"
    )
    ...
    try:
        if args.benchmark:
            ...
            success = run_category_tests(
                args.category, verbose=args.verbose, quick=args.quick
            )
        else:
            success = run_all_tests(
                verbose=args.verbose, quick=args.quick, parallel=args.parallel
            )
